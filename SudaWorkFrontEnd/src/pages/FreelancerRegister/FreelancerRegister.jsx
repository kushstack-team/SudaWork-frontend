...
const FreelancerRegister = () => {
  ...
  return (
    <div className="freelancer-register-page" dir="rtl">
      {/* Header */}
      <header className="freelancer-register-header">
        <div className="freelancer-register-header__container">
          <Link to="/" className="freelancer-register-logo" aria-label="Sudawork Home">
            <img src={logo} alt="Sudawork" className="freelancer-register-logo__img" />
          </Link>
        </div>
      </header>

      {/* Main Container */}
      <main className="freelancer-register-main">
        {/* Main Heading */}
        <h1 className="freelancer-register-title">سجل الدخول لتجد عمل</h1>

        {/* Social Auth Buttons */}
        <div className="freelancer-register-socials">
        ...
        {/* Divider */}
        <div className="freelancer-register-divider">
          <span className="freelancer-register-divider__text">او</span>
        </div>
        ...
        <form className="freelancer-register-form" onSubmit={handleSubmit}>
          ...
          <div className="form-actions">
            ...
            <p className="freelancer-register-footer-text">
              ...
              <Link to="/login" className="freelancer-register-login-link">
                سجل الدخول
              </Link>
            </p>
          </div>
